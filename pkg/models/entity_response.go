...
func (m *EntityResponse) validateAffiliation(formats strfmt.Registry) error {
...
func (m *EntityResponse) contextValidateAffiliation(ctx context.Context, formats strfmt.Registry) error {
